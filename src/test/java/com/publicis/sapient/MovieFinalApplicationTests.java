...
import com.publicis.sapient.controller.LoginController;
...
class MovieFinalApplicationTests extends AbstractTest {
	 ...
	 * "/customer/add"; Customer cu=new Customer("Bajrang", "Anantapur", "7569369939",
	 * "Bajrang@gmail.com", "bunny"); String inputJson = super.mapToJson(cu);
	...
	public void viewCustomerList() throws Exception {
		loginController.loginUser("Bajrang", "publicissapient@1");
	...
	public void addATicket() throws Exception {
		...
		Customer cu = new Customer("Bajrang", "Anantapur", "7569369939", "Bajrang@gmail.com", "bunny");
